...
│
├── a)MEDIUM/                 # Proiecte nivel mediu (15)
...
│
├── c)ADVANCED/               # Proiecte nivel avansat (3)
...
- Materialele din Seminar 1 până la Seminar 6
...
3. ✅ Alege un proiect din `a)MEDIUM/`, `b)EASY/` sau `c)ADVANCED/`
