...
> Seminar 03 | Material teoretic complet cu Subgoal Labels  
...
### SUB-OBIECTIV 1.1.1: Înțelege structura comenzii find
...
### SUB-OBIECTIV 1.2.1: Caută după nume
...
### SUB-OBIECTIV 1.2.2: Caută după tip
...
### SUB-OBIECTIV 1.6.1: De ce xargs?
...
### SUB-OBIECTIV 1.3.2: Caută după timp
...
### SUB-OBIECTIV 1.3.3: Caută după permisiuni și owner
...
### SUB-OBIECTIV 1.4.1: Combină condiții cu `-and`, `-or` și `!`
...
### SUB-OBIECTIV 1.5.1: -print și variante
...
### SUB-OBIECTIV 1.6.3: Combinații find | xargs
...
### SUB-OBIECTIV 2.4.2: OPTARG și OPTIND
...
### SUB-OBIECTIV 1.6.2: Sintaxă și opțiuni xargs
...
### SUB-OBIECTIV 1.7.1: Înțelege diferența locate vs find
...
### SUB-OBIECTIV 2.1.1: Variabilele de bază
...
### SUB-OBIECTIV 2.1.2: $@ vs $* - diferența crucială
...
### SUB-OBIECTIV 2.1.3: Argumente peste 9
...
### SUB-OBIECTIV 2.2.1: Înțelege și folosește shift
...
### SUB-OBIECTIV 2.3.1: Expansiuni cu default
...
### SUB-OBIECTIV 2.4.1: Sintaxa getopts
...
### SUB-OBIECTIV 2.5.1: Pattern pentru --option
...
### SUB-OBIECTIV 2.6.1: Template script profesional
...
### SUB-OBIECTIV 4.4.1: Mediul de execuție
...
### SUB-OBIECTIV 3.1.1: Structura rwx
...
### SUB-OBIECTIV 3.1.2: Semnificația pe fișiere vs directoare
...
### SUB-OBIECTIV 3.2.1: Calculul octal
...
### SUB-OBIECTIV 3.3.2: chmod recursiv
...
### SUB-OBIECTIV 3.5.1: Cum funcționează umask
...
### SUB-OBIECTIV 3.6.3: Sticky Bit (1xxx)
...
### SUB-OBIECTIV 4.2.1: Cele 5 câmpuri
...
### SUB-OBIECTIV 4.2.2: Caractere speciale
...
### SUB-OBIECTIV 4.2.3: String-uri speciale
...
### SUB-OBIECTIV 4.4.3: Prevenire execuții multiple
...
### SUB-OBIECTIV 4.4.2: Logging și debugging
...
### SUB-OBIECTIV 1.3.1: Caută după dimensiune
