...
ls -la ~/seminarii/SEM05-06_COMPLET/

# Testează toate scripturile demo
cd ~/seminarii/SEM05-06_COMPLET/scripts/demo/
for script in *.sh; do
    echo "=== Testing $script ==="
...
less ~/seminarii/SEM05-06_COMPLET/docs/S03_02_MATERIAL_PRINCIPAL.md
```
...
*Ghid creat pentru Seminar 5-6 SO | ASE București - CSIE*  
