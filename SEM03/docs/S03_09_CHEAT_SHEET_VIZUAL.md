...
## Seminarul 5-6 | Sisteme de Operare | ASE București - CSIE
...
│   │ │  │  └── Others (o) - ceilalți                              │
│   │ │  └── Group (g) - grupul                                    │
│   │ └── User/Owner (u) - proprietarul                            │
│   └── Tip fișier (- fișier, d director, l link)                  │
│                                                                   │
├───────────────────────────────────────────────────────────────────┤
│                    SEMNIFICAȚIA BIȚILOR                           │
├─────────┬──────────────────────┬──────────────────────────────────┤
│  BIT    │    PE FIȘIER         │    PE DIRECTOR                   │
├─────────┼──────────────────────┼──────────────────────────────────┤
│  r (4)  │ Citire conținut      │ Listare conținut (ls)            │
│  w (2)  │ Modificare conținut  │ Creare/ștergere fișiere          │
│  x (1)  │ Executare            │ Acces (cd) în director           │
└─────────┴──────────────────────┴──────────────────────────────────┘

⚠️  x pe director ≠ executare! Înseamnă ACCES!
⚠️  Pentru a șterge un fișier, ai nevoie de w pe DIRECTOR, nu pe fișier!
```
