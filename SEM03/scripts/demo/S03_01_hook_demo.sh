...
# Seminar 3: Demonstrație spectaculoasă pentru captarea atenției
#
# SCOP: Arată puterea comenzii find și utilităților Unix într-un mod vizual
#       și interesant pentru a "prinde" studenții de la început
#
# UTILIZARE:
...
main() {
    ...
    echo -e "${DIM}Seminar 3: Utilitare Avansate, Scripturi, Permisiuni, Automatizare${NC}"
}
