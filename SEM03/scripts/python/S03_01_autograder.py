...
"""
═══════════════════════════════════════════════════════════════════════════════
S03_01_autograder.py - Sistem de Evaluare Automată pentru Seminar 3
═══════════════════════════════════════════════════════════════════════════════
Sisteme de Operare | ASE București - CSIE

DESCRIERE:
    Evaluator automat pentru temele din Seminarul 03 care verifică:
...
class Autograder:
    """Evaluator automat pentru teme Seminar 3"""
...
class ReportGenerator:
    ...
    def print_console_report(result: GradingResult):
        ...
        print(f"{c.CYAN}║{c.RESET} {c.BOLD}RAPORT EVALUARE - Seminar 3 SO{c.RESET}")
        print(f"{c.CYAN}{'═' * 80}{c.RESET}")
        print()
    ...
    def generate_markdown_report(result: GradingResult) -> str:
        ...
        lines = [
            f"# Raport Evaluare - Seminar 3 SO",
            "",
...
def main():
    parser = argparse.ArgumentParser(
        description='Evaluator automat pentru teme Seminar 3 SO',
