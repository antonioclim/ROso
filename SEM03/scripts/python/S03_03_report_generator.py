...
*Raport generat automat de Report Generator SEM03 v{VERSION}*
"""
...
<body>
    <div class="container">
        ...
        <div class="footer">
            Generat: {datetime.now().strftime('%Y-%m-%d %H:%M')} • Report Generator SEM03 v{VERSION}
        </div>
    </div>
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Generator de Rapoarte pentru Seminarul 03 SO',
