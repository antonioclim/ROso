...
VERSION = "1.0"
PROGRAM_NAME = "Quiz Generator - SEM05-06"
...
Control cu MAILTO în crontab:
  MAILTO=admin@example.com    # trimite aici
...
def print_banner(use_color: bool = True):
    ...
    ║                                                                  ║
    ║              Seminar 5-6: Find, Permisiuni, Cron                 ║
    ╚══════════════════════════════════════════════════════════════════╝
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Generator de Quiz-uri pentru Seminarul 5-6 SO',
...
Exemple:
  ...
  %(prog)s --stats                          # Afișează statistici
    ...
    # Creează quiz-ul
    title = f"Quiz SEM05-06: {category.value.replace('_', ' ').title()}"
