...
Predă o arhivă `tema_sem56_NUME_PRENUME.tar.gz` cu structura:
...
```bash
# Creează structura
mkdir -p tema_sem56_NUME_PRENUME/{parte1_find,parte2_script,parte3_permissions,parte4_cron,parte5_integration}

# După ce ai completat toate fișierele:
cd ~
tar -czvf tema_sem56_NUME_PRENUME.tar.gz tema_sem56_NUME_PRENUME/

# Verifică conținutul:
tar -tzvf tema_sem56_NUME_PRENUME.tar.gz
```
...
```bash
#!/bin/bash
# Tema Sem 5-6 Partea 1: Find Master
# Nume: [COMPLETEAZĂ]
# Grupa: [COMPLETEAZĂ]
...
- [ ] Arhiva are numele corect: `tema_sem56_NUME_PRENUME.tar.gz`
- [ ] Am verificat conținutul arhivei înainte de trimitere

---

*Tema Seminar 5-6 | Sisteme de Operare | ASE București - CSIE*
