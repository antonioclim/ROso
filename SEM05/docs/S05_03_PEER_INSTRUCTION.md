...
Pentru fiecare întrebare din acest document, urmați protocolul:

1. **Afișați întrebarea** (30 de secunde pentru citire)
2. **Vot individual** — studenții votează A/B/C/D în liniște (fără discuții)
3. **Notați distribuția** — scrieți procentele pe tablă: A:__% B:__% C:__% D:__%
4. **Punct decizional:**
   - Dacă **>70% corect**: explicație scurtă, mergeți mai departe
   - Dacă **30–70% corect**: discuție între colegi (2–3 min), apoi revot
   - Dacă **<30% corect**: este necesară o mini‑explicație înainte de revot
5. **Dezvăluiți răspunsul** și explicația (2 min)

### Condiții optime

- **Acuratețe țintă la primul vot:** 40–60% (maximizează învățarea prin discuție)
- **Grupuri de discuție:** 2–3 studenți, preferabil cu răspunsuri inițiale diferite
- **Îmbunătățire la revot:** așteptați o creștere de 20–30% după discuție

### Notarea întrebărilor

Fiecare întrebare include:
- **Nivel Bloom:** nivelul cognitiv evaluat
- **Misconcepție țintă:** eroarea conceptuală frecventă vizată
- **Analiza distractorilor:** de ce răspunsurile greșite sunt tentante
