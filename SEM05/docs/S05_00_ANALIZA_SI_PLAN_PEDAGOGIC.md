# Analiză și Plan Pedagogic - Seminar 9-10
## Advanced Bash Scripting | Sisteme de Operare
...
### 3.3 Materiale de Generat

| Prioritate | Material | Scop | Lungime Țintă |
|------------|----------|------|---------------|
| P1 | S05_01_GHID_INSTRUCTOR.md | Ghid pas-cu-pas | 700+ linii |
| P1 | S05_02_MATERIAL_PRINCIPAL.md | Teorie completă | 900+ linii |
| P1 | S05_03_PEER_INSTRUCTION.md | Întrebări MCQ | 550+ linii |
| P2 | S05_04_PARSONS_PROBLEMS.md | Reordonare cod | 350+ linii |
| P2 | S05_05_LIVE_CODING_GUIDE.md | Script instructor | 550+ linii |
| P2 | S05_06_EXERCITII_SPRINT.md | Exerciții cronometrate | 450+ linii |
| P3 | S05_07_LLM_AWARE_EXERCISES.md | Exerciții AI-aware | 400+ linii |
| P3 | S05_08_DEMO_SPECTACULOASE.md | Demo-uri vizuale | 400+ linii |
| P3 | S05_09_CHEAT_SHEET_VIZUAL.md | One-pager | 350+ linii |
| P3 | S05_10_AUTOEVALUARE_REFLEXIE.md | Auto-evaluare | 250+ linii |
