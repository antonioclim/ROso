...
## 6. Aliniere cu evaluarea

### Mapare LO → temă

| LO | Cerință din temă | Criterii din rubrică |
|----|------------------|----------------------|
| **LO1** | R1: parse_line(), count_levels() | Funcții definite cu structură corectă |
| **LO2** | R3: Refactorizare — corectarea variabilelor globale | Toate variabilele folosesc `local` în interiorul funcțiilor |
| **LO3** | R1: return în get_top_messages() | Funcțiile „returnează” prin echo, capturat cu $() |
| **LO4** | R1: numărare cu arrays în analiză log | Arrays indexate declarate și iterate corect |
| **LO5** | R2: hash CONFIG | `declare -A` utilizat pentru toate arrays asociative |
| **LO6** | R1, R2: iterare arrays | Ghilimele folosite în tiparul `"${arr[@]}"` |
| **LO7** | R1, R2, R3: antet scripturi | `set -euo pipefail` prezent în toate scripturile |
| **LO8** | R1, R3: curățare | trap EXIT implementat cu funcție cleanup |
| **LO9** | R3: identificarea bug-urilor în broken_script | Identificare corectă a limitărilor lui set -e |
| **LO10** | Toate cerințele | Structura șablonului profesional este urmată |

### Ponderi criterii din rubrică

| Criteriu | Pondere | LO principale |
|----------|---------|---------------|
| Funcționalitate | 40% | LO1, LO3, LO4, LO5 |
| Stil de cod | 25% | LO1, LO6, LO7 |
| Gestionarea erorilor | 20% | LO7, LO8, LO9 |
| Documentație | 15% | LO10 |

---

## 7. Distribuția tipurilor de activități

### Distribuția țintă (Principiul 10 Brown & Wilson)

| Tip de activitate | Țintă | Actual | Status |
|-------------------|-------|--------|--------|
| Scriere de cod | 45–55% | 48% | ✓ |
| Parsons / reordonare | 15–20% | 18% | ✓ |
| Trasare / predicție | 15–20% | 17% | ✓ |
| Depanare / corectare | 10–15% | 12% | ✓ |
| Explicare / revizuire | 5–10% | 5% | ✓ |

### Alocarea timpului într-un seminar de 100 de minute

| Activitate | Minute | Procent |
|----------|--------|---------|
| Demo de „hook” | 8 | 8% |
| Peer Instruction (6 întrebări) | 18 | 18% |
| Live coding | 25 | 25% |
| Parsons Problems (3 selectate) | 12 | 12% |
| Exerciții sprint | 20 | 20% |
| Pauză | 10 | 10% |
| Consolidare / Q&A | 7 | 7% |

### Verificare distribuție Bloom

| Nivel | Țintă (începători) | Quiz actual | Status |
|-------|---------------------|-------------|--------|
| Remember | 15–20% | 11% (2/18) | Ușor sub țintă |
| Understand | 25–30% | 44% (8/18) | Peste țintă |
| Apply | 30–35% | 28% (5/18) | În interval |
| Analyse | 10–15% | 11% (2/18) | În interval |
| Evaluate | 3–5% | 6% (1/18) | În interval |
| Create | 3–5% | 0% | OK (acoperit în temă) |

---

*Document generat pentru trasabilitatea rezultatelor de învățare (Learning Outcomes) — Seminar 5*  
*Versiunea 1.1.0 — adăugate alinierea cu evaluarea și distribuția activităților*
