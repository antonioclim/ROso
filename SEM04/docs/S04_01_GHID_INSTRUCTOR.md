...
Realitatea: E imposibil să acoperi totul în profunzime în 100 de minute.
...
Scop: Captează atenția arătând puterea grep+awk într-un one-liner magic.
...
echo "💡 Aceasta e puterea grep + awk + sort + uniq!"
