# Analiză și Plan Pedagogic - Seminar 7-8
...
### 2.5 Misconcepții despre Nano

| ID | Misconcepție | Frecvență | Consecință | Clarificare |
|----|--------------|-----------|------------|-------------|
| M5.1 | "CTRL+S salvează" | 70% | Blocare terminal | `CTRL+O` pentru Write Out |
| M5.2 | "nano nu are syntax highlighting" | 45% | Subutilizare | Are, dar trebuie activat în `.nanorc` |
| M5.3 | "^ înseamnă tasta ^" | 30% | Comenzi nefuncționale | `^` = tasta **CTRL** |
