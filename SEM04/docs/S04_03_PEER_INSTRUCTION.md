...
## Protocolul Peer Instruction

### Procedura standard de vot

Pentru fiecare întrebare din acest document, urmați acest protocol:

1. **Afișarea întrebării** (30 de secunde pentru citire)
2. **Vot individual** — Studenții votează A/B/C/D în tăcere (fără discuții)
3. **Înregistrarea distribuției** — Notați pe tablă procentele: A:__% B:__% C:__% D:__%
4. **Punct de decizie:**
   - Dacă **>70% corect**: explicație scurtă, apoi continuați
   - Dacă **30–70% corect**: discuție între colegi (2–3 min), apoi revotare
   - Dacă **<30% corect**: este necesară o mini-lecție înainte de revotare
5. **Dezvăluirea răspunsului** cu explicație (2 min)

### Condiții optime

- **Acuratețea-țintă la primul vot:** 40–60% (maximizează învățarea prin discuție)
- **Grupuri de discuție:** 2–3 studenți cu răspunsuri inițiale diferite
- **Îmbunătățirea la revotare:** se așteaptă o creștere de 20–30% după discuție

### Notația întrebărilor

Fiecare întrebare include:
- **Nivel Bloom:** nivelul cognitiv evaluat
- **Ținta de concepție eronată:** care eroare frecventă este testată
- **Analiza distractorilor:** de ce răspunsurile greșite sunt plauzibile
