# Seminar 3-4: Operatori de Control, Redirecționare I/O, Filtre și Bucle
...
Acest seminar este continuarea naturală a SEM01-02 (Introducere în Bash, Navigare, Variabile, Globbing de bază). Presupunem că studenții au deja familiaritate cu:
...
unzip SEM03-04_COMPLET.zip
cd SEM03-04_COMPLET

# Sau dacă ai primit .tar.gz
tar xzf SEM03-04_COMPLET.tar.gz
cd SEM03-04_COMPLET
```
...
wget https://materiale.ase.ro/so/SEM03-04_COMPLET.zip
unzip SEM03-04_COMPLET.zip
cd SEM03-04_COMPLET
./scripts/bash/S02_01_setup_seminar.sh
```
