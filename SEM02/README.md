...
- Procese și coduri de ieșire - cum comunică programele între ele
- descriptori de fișier - modelul Unix de I/O
...
6. Diagnosticheze erori în scripturi folosind coduri de ieșire și PIPESTATUS
...
│   ├── S02_00_PEDAGOGICAL_ANALYSIS_PLAN.md   # Analiză materiale + plan
│   ├── S02_01_INSTRUCTOR_GUIDE.md             # Ghid pas-cu-pas pentru instructor
│   ├── S02_02_MAIN_MATERIAL.md          # Material teoretic complet
...
│   ├── S02_06_SPRINT_EXERCISES.md            # Exerciții cronometrate
│   ├── S02_07_LLM_AWARE_EXERCISES.md         # Exerciții cu evaluare LLM
│   ├── S02_08_SPECTACULAR_DEMOS.md          # Demo-uri vizuale
│   ├── S02_09_VISUAL_CHEAT_SHEET.md          # One-pager cu comenzi
│   └── S02_10_SELF_ASSESSMENT_REFLECTION.md       # Checkpoint-uri metacognitive
│
├── scripts/                            # 🔧 Scripturi funcționale
│   ├── bash/                           # Utilitare Bash
│   │   ├── S02_01_setup_seminar.sh          # Setup mediu de lucru
│   │   ├── S02_02_interactive_quiz.sh        # Quiz cu dialog/text
...
│   │   ├── S02_03_demo_redirection.sh       # Demonstrație I/O
│   │   ├── S02_04_demo_filters.sh            # Showcase filtre
│   │   └── S02_05_demo_loops.sh             # Exemple bucle
│   │
...
│
├── presentations/                         # 📊 Prezentări HTML
│   ├── S02_01_presentation.html              # Prezentare principală (reveal.js)
│   └── S02_02_cheat_sheet.html             # Cheat sheet printabil
│
├── homework/                               # 📝 Teme și exerciții
...
│   │
│   ├── S02_01_HOMEWORK.md                      # Specificații temă
│   └── S02_02_create_homework.sh              # Generator structură temă
│
├── resources/                            # 📚 Resurse adiționale
│   └── S02_RESOURCES.md                      # Linkuri și bibliografie
│
└── tests/                              # ✅ Teste și validare
...
Acest curs **permite** utilizarea uneltelor AI (ChatGPT, Claude, Copilot etc.) cu anumite condiții:

### Ce Este Permis
- ✅ Folosește AI pentru brainstorming, căutare sintaxă, indicii debugging
- ✅ Întreabă AI să explice concepte sau mesaje de eroare
- ✅ Generează cod boilerplate ca punct de pornire

### Ce Este Obligatoriu
- 📝 Documentează utilizarea AI în `REFLECTION.md` (ce ai întrebat, ce ai modificat)
- 🧪 Testează tot codul generat de AI — are adesea bug-uri subtile
- 🧠 Înțelege fiecare linie pe care o predai

### Ce Trebuie Evitat
- ❌ Predarea output-ului AI fără a-l înțelege
- ❌ Copy-paste fără testare
- ❌ Așteptarea ca AI să gestioneze corect cazurile limită

### De Ce Contează
Autograder-ul include detectare pattern-uri AI. Temele cu amprente AI evidente (comentarii excesiv de elaborate, formatare suspect de perfectă, nume de variabile descriptive neobișnuite pentru începători) pot primi penalizări:
- 2-4 indicatori AI: doar avertisment
- 3-4 indicatori AI: -5% penalizare
- 5+ indicatori AI: -10% penalizare + review manual

**Filozofia**: Nu interzicem AI pentru că vei folosi aceste unelte profesional. Mai bine să înveți evaluarea critică acum decât să faci greșeli costisitoare mai târziu. Scopul este să devii un evaluator priceput al output-ului AI, nu doar un consumator.

Vezi `docs/S02_07_LLM_AWARE_EXERCISES.md` pentru exerciții special concepute pentru a construi aceste abilități.
...
1. Parcurge materialul principal: `docs/S02_02_MAIN_MATERIAL.md`
2. Fă exercițiile din sprint-uri: `docs/S02_06_SPRINT_EXERCISES.md`
3. Testează-ți înțelegerea: `./scripts/bash/S02_02_interactive_quiz.sh`
4. Completează tema: `homework/S02_01_HOMEWORK.md`
...
| 🔴 Obligatoriu | Exerciții de sprint (minim 3) | 30 min practică |
...
./homework/S02_02_create_homework.sh "NumeTau" "GrupaXX"
...
### 7. coduri de ieșire ciudate în pipeline-uri
