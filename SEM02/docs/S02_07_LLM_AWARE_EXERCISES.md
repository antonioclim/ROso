...
| coduri de ieșire ignorate | 65% | Nu verifică succes comenzi |
...
## EXERCIȚIU L6: Detectivul de Amprente AI

Durată: 10 min | Mod: Individual | Nivel: ⭐⭐⭐

### Obiectiv
Să înveți să recunoști pattern-urile codului generat de AI — o abilitate care te va ajuta să evaluezi propria muncă asistată de AI și să eviți „semnele" evidente care declanșează detectarea automată.

### Provocarea
Primești două scripturi care realizează aceeași sarcină (numără fișierele obișnuite dintr-un director). Unul a fost scris de un student sub presiunea timpului, unul de ChatGPT. Sarcina ta: să determini care e care.
...
```bash
#!/bin/bash
# Acest script numără fișierele obișnuite din directorul curent
# Iterează prin toate elementele și verifică dacă fiecare este fișier obișnuit
# Contorul este stocat într-o variabilă și afișat la final
...
echo "Total fișiere obișnuite: $file_count"
```

### Sarcină

Completează această analiză:
...
╠════════════════════════════════════════════════════════════════════╣
║                                                                    ║
║  1. Care script este generat de AI?  □ A  □ B                      ║
║                                                                    ║
║  2. Ce „semne" l-au trădat? (listează cel puțin 3)                 ║
║     a) ________________________________________________            ║
║     b) ________________________________________________            ║
║     c) ________________________________________________            ║
║                                                                    ║
║  3. Pe care l-ai preda TU ca temă? □ A  □ B                        ║
║     De ce? __________________________________________________      ║
║                                                                    ║
║  4. Dacă ai folosit AI pentru a scrie cod, cum ai modifica         ║
║     rezultatul pentru a-l face să pară mai „uman"?                 ║
║     ____________________________________________________________   ║
║                                                                    ║
╚════════════════════════════════════════════════════════════════════╝
```

### Puncte de Discuție (pentru instructor)

**Semne AI comune prezente în Script B:**
1. Denumire variabile: `file_count` vs `c` — începătorii sub presiune folosesc nume scurte
2. Densitate comentarii: 3 linii de comentarii pentru 7 linii de cod (43%) — studenții comentează puțin
3. Formatare output: „Total fișiere obișnuite:" vs număr brut — AI adoră output lustruit
4. Stil consistent: Indentare perfectă peste tot — studenții sunt mai dezordonați
5. Explicații în comentarii: AI explică *ce* face codul; studenții explică *de ce* (dacă o fac)

**Ironia:** Script B este tehnic cod „mai bun" — dar exact asta îl face suspect pentru o temă de începător. Codul bun de la un novice ar trebui să aibă margini nefinisate.

**Punct cheie de predare:** Înțelegerea acestor pattern-uri ajută studenții în două moduri:
- Evaluează codul generat de AI mai critic
- Dacă folosesc asistență AI, învață să „umanizeze" rezultatul corespunzător

### Grilă de Evaluare

| Criteriu | Puncte |
|----------|--------|
| Identificare corectă script AI | 3p |
| Minimum 3 semne AI identificate | 3p |
| Justificare alegere pentru predare | 2p |
| Strategie de umanizare | 2p |
| **Total** | **10p** |
