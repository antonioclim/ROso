#!/bin/bash
# 
#  S02_02_creeaza_tema.sh - Generator Template Temă Seminar 3-4
# 
#
# DESCRIERE:
...
#  Tema Seminar 3-4: Operatori, Redirecționare, Filtre, Bucle
...
echo ""
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo -e "${BOLD}   🔍 VERIFICARE TEMĂ - Seminar 3-4${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo ""
