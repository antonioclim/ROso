# SEM06 - CAPSTONE: Proiecte Integrate Bash
...
## Sisteme de Operare | Seminarele 11-12 (Finalizare)
...
│   ├── S06_00_Introducere_CAPSTONE.md    # Overview și obiective
│   ├── S06_01_Arhitectura_Proiectelor.md # Design patterns, modularizare
│   ├── S06_02_Monitor_Implementare.md    # Proiect Monitor detaliat
│   ├── S06_03_Backup_Implementare.md     # Proiect Backup detaliat
│   ├── S06_04_Deployer_Implementare.md   # Proiect Deployer detaliat
│   ├── S06_05_Testing_Framework.md       # Framework testare Bash
│   ├── S06_06_Error_Handling.md          # Trap, logging, exit codes
│   ├── S06_07_Deployment_Strategies.md   # Rolling, Blue-Green, Canary
│   ├── S06_08_Automatizare_Cron.md       # Cron și systemd timers
│   ├── S06_09_CheatSheet_Bash.md         # Quick reference
│   └── S06_10_Autoevaluare.md            # Checklist și reflecție
│
├── 📂 prezentari/                  # Prezentări HTML (Reveal.js)
│   ├── S06_00_Introducere.html
│   ├── S06_02_Monitor.html
│   ├── S06_03_Backup.html
...
|---|----------|-----------|-------|
| 00 | `S06_00_Introducere_CAPSTONE.md` | Overview, obiective, arhitectură | Conceptual |
| 01 | `S06_01_Arhitectura_Proiectelor.md` | Design patterns, modularizare | Arhitectură |
| 02 | `S06_02_Monitor_Implementare.md` | Parsing /proc, metrici, alerting | Implementare |
| 03 | `S06_03_Backup_Implementare.md` | Full/incremental, compresie | Implementare |
| 04 | `S06_04_Deployer_Implementare.md` | Strategii deployment, health checks | Implementare |
| 05 | `S06_05_Testing_Framework.md` | Assertions, mocking, TDD | Testing |
| 06 | `S06_06_Error_Handling.md` | Exit codes, traps, logging | Stabilitate |
| 07 | `S06_07_Deployment_Strategies.md` | Rolling vs Blue-Green vs Canary | Teorie |
| 08 | `S06_08_Automatizare_Cron.md` | Cron, systemd timers | Automatizare |
| 09 | `S06_09_CheatSheet_Bash.md` | Quick reference complet | Referință |
| 10 | `S06_10_Autoevaluare.md` | Checklist și reflecție | Evaluare |
...
```bash
# Direct în browser
firefox prezentari/S06_00_Introducere.html
...
Vezi `teme/TEME_PRACTICE.md` pentru detalii complete.
...
resurse/systemd/monitor.service

# Timer pentru Backup automatizat
resurse/systemd/backup.timer
resurse/systemd/backup.service
```
...
resurse/templates/bash_script_template.sh
```
...
resurse/examples/cron_examples.txt
```
