...
2. **Proiect Integrat** - combinarea tuturor componentelor
...
- Material proiecte: `../docs/S06_*`
- Cod de bază: `../scripts/projects/`
- Framework testare: `../scripts/test_helpers.sh`

---

*Vezi `S06_01_TEMA_CAPSTONE.md` pentru cerințe detaliate.*
