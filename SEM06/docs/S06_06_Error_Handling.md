...
> **Observație din laborator:** un reflex bun: după o comandă care *poate* eşua, uită-te la exit code (`echo $?`) şi la output. În Bash, `set -euo pipefail` te ajută, dar nu te scuteşte de gândit: verifică input-ul şi tratează cazurile-limită.
## Introducere
