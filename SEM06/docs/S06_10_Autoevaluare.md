...
> Seminar 11-12: Proiecte CAPSTONE
...
|------|---------------------|
| Variabile/Expansiune | `docs/S06_09_CheatSheet_Bash.md` |
| Control Flow | `docs/S06_01_Arhitectura_Proiectelor.md` |
| Funcții/Arrays | `docs/S06_01_Arhitectura_Proiectelor.md` |
| I/O/Text Processing | `docs/S06_02_Monitor_Implementare.md` |
...
*Seminar 11-12 CAPSTONE | Completează-l la începutul și sfârșitul modulului*
