...
## Conținut Folder homework/

| Fișier | Descriere | Audiență |
|--------|-----------|----------|
| `S06_00_README.md` | Acest document explicativ | Instructori |
| `S06_01_HOMEWORK_CAPSTONE.md` | Cerințe complete pentru proiectele CAPSTONE | Studenți |
...
| Structură fișiere | `S0X_01_TEMA.md` + script generare | `S06_01_HOMEWORK_CAPSTONE.md` (fișier unic mare) |
...
```
S06_01_HOMEWORK_CAPSTONE.md conține:
│
...
- `S06_01_HOMEWORK_CAPSTONE.md` (redenumit din TEME_PRACTICE.md)
