# Seminar 1-2: Shell Bash - Pachet Complet
...
Acest pachet conține toate materialele necesare pentru **Seminar 1-2: Shell Bash**
...
wget [URL]/SEM01-02_COMPLET.zip
unzip SEM01-02_COMPLET.zip
cd SEM01-02_COMPLET
```

### Metoda 2: Copiere pe Stick USB
1. Copiază întregul folder `SEM01-02_COMPLET`
