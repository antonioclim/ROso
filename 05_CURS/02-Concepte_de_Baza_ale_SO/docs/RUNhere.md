# 📁 Documentație Curs 02 — Concepte de Bază ale SO

> **Locație:** `05_LECTURES/02-Concepte_de_Baza_ale_SO/docs/`  
> **Temă:** Întreruperi, syscalls, DMA
...
| Fișier | Descriere |
|--------|-----------|
| `C02_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C02_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C02_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C02_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C02_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C02_05_EVALUARE_FORMATIVA.yaml
```
