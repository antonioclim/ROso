# 📁 Documentație Curs 15supp — Conectarea la Rețea

> **Locație:** `05_LECTURES/15supp-Conectarea_la_Retea/docs/`  
> **Temă:** Socket API, TCP/UDP
...
| Fișier | Descriere |
|--------|-----------|
| `C15_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C15_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C15_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C15_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C15_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C15_05_EVALUARE_FORMATIVA.yaml
```
