# 📁 Documentație Curs 06 — Sincronizare (P1)

> **Locație:** `05_LECTURES/06-Sincronizare_(Part1_Peterson+locks+mutex)/docs/`  
> **Temă:** Race conditions, Peterson, mutex
...
| Fișier | Descriere |
|--------|-----------|
| `C06_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C06_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C06_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C06_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C06_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C06_05_EVALUARE_FORMATIVA.yaml
```
