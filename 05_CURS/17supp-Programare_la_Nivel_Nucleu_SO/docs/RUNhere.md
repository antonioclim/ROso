# 📁 Documentație Curs 17supp — Programare la Nivel Nucleu

> **Locație:** `05_LECTURES/17supp-Programare_la_Nivel_Nucleu_SO/docs/`  
> **Temă:** Module kernel, eBPF
...
| Fișier | Descriere |
|--------|-----------|
| `C17_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C17_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C17_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C17_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C17_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C17_05_EVALUARE_FORMATIVA.yaml
```
