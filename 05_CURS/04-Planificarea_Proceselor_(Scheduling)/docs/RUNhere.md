# 📁 Documentație Curs 04 — Planificarea Proceselor

> **Locație:** `05_LECTURES/04-Planificarea_Proceselor_(Scheduling)/docs/`  
> **Temă:** Algoritmi de scheduling, FCFS, RR, MLFQ
...
| Fișier | Descriere |
|--------|-----------|
| `C04_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C04_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C04_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C04_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C04_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C04_05_EVALUARE_FORMATIVA.yaml
```
