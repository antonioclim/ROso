# 📁 Documentație Curs 14 — Virtualizare

> **Locație:** `05_LECTURES/14-Virtualizare+RECAP/docs/`  
> **Temă:** VM, containere, recap
...
| Fișier | Descriere |
|--------|-----------|
| `C14_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C14_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C14_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C14_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C14_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C14_05_EVALUARE_FORMATIVA.yaml
```
