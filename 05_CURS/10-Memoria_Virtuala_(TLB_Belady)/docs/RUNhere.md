# 📁 Documentație Curs 10 — Memoria Virtuală

> **Locație:** `05_LECTURES/10-Memoria_Virtuala_(TLB_Belady)/docs/`  
> **Temă:** TLB, Bélády, înlocuire pagini
...
| Fișier | Descriere |
|--------|-----------|
| `C10_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C10_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C10_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C10_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C10_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C10_05_EVALUARE_FORMATIVA.yaml
```
