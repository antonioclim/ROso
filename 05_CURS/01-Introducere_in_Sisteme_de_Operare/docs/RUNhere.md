# 📁 Documentație Curs 01 — Introducere în Sisteme de Operare

> **Locație:** `05_LECTURES/01-Introducere_in_Sisteme_de_Operare/docs/`  
> **Temă:** Istoria SO, structura, modurile kernel
...
| Fișier | Descriere |
|--------|-----------|
| `C01_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C01_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C01_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C01_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C01_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C01_05_EVALUARE_FORMATIVA.yaml
```
