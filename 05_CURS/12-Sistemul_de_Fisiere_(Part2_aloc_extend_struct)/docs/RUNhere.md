# 📁 Documentație Curs 12 — Sistemul de Fișiere (P2)

> **Locație:** `05_LECTURES/12-Sistemul_de_Fisiere_(Part2_aloc_extend_struct)/docs/`  
> **Temă:** Alocare, journaling, extent
...
| Fișier | Descriere |
|--------|-----------|
| `C12_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C12_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C12_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C12_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C12_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C12_05_EVALUARE_FORMATIVA.yaml
```
