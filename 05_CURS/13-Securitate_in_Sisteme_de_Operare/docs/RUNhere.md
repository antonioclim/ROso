# 📁 Documentație Curs 13 — Securitate în SO

> **Locație:** `05_LECTURES/13-Securitate_in_Sisteme_de_Operare/docs/`  
> **Temă:** Permisiuni, AAA, ACL
...
| Fișier | Descriere |
|--------|-----------|
| `C13_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C13_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C13_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C13_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C13_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C13_05_EVALUARE_FORMATIVA.yaml
```
