# 📁 Documentație Curs 07 — Sincronizare (P2)

> **Locație:** `05_LECTURES/07-Sincronizare_(Part2_semafor_buffer)/docs/`  
> **Temă:** Semafoare, producător-consumator
...
| Fișier | Descriere |
|--------|-----------|
| `C07_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C07_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C07_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C07_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C07_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C07_05_EVALUARE_FORMATIVA.yaml
```
