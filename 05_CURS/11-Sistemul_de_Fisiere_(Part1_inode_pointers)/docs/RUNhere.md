# 📁 Documentație Curs 11 — Sistemul de Fișiere (P1)

> **Locație:** `05_LECTURES/11-Sistemul_de_Fisiere_(Part1_inode_pointers)/docs/`  
> **Temă:** Inode, pointeri, linkuri
...
| Fișier | Descriere |
|--------|-----------|
| `C11_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C11_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C11_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C11_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C11_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C11_05_EVALUARE_FORMATIVA.yaml
```
