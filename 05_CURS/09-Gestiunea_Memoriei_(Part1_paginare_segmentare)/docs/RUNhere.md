# 📁 Documentație Curs 09 — Gestiunea Memoriei (P1)

> **Locație:** `05_LECTURES/09-Gestiunea_Memoriei_(Part1_paginare_segmentare)/docs/`  
> **Temă:** Paginare, segmentare
...
| Fișier | Descriere |
|--------|-----------|
| `C09_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C09_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C09_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C09_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C09_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C09_05_EVALUARE_FORMATIVA.yaml
```
