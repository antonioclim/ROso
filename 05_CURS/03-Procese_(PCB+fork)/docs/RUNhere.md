# 📁 Documentație Curs 03 — Procese

> **Locație:** `05_LECTURES/03-Procese_(PCB+fork)/docs/`  
> **Temă:** PCB, stări, fork/exec
...
| Fișier | Descriere |
|--------|-----------|
| `C03_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C03_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C03_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C03_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C03_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C03_05_EVALUARE_FORMATIVA.yaml
```
