# 📁 Documentație Curs 05 — Fire de Execuție

> **Locație:** `05_LECTURES/05-Fire_de_Executie_(Threads)/docs/`  
> **Temă:** Thread-uri, modele, context switch
...
| Fișier | Descriere |
|--------|-----------|
| `C05_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C05_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C05_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C05_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C05_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C05_05_EVALUARE_FORMATIVA.yaml
```
