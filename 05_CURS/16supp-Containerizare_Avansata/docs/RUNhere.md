# 📁 Documentație Curs 16supp — Containerizare Avansată

> **Locație:** `05_LECTURES/16supp-Containerizare_Avansata/docs/`  
> **Temă:** Namespace, cgroups, overlay
...
| Fișier | Descriere |
|--------|-----------|
| `C16_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C16_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C16_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C16_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C16_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C16_05_EVALUARE_FORMATIVA.yaml
```
