# 📁 Documentație Curs 08 — Interblocare

> **Locație:** `05_LECTURES/08-Interblocare_(Coffman)/docs/`  
> **Temă:** Condițiile Coffman, prevenire, evitare
...
| Fișier | Descriere |
|--------|-----------|
| `C08_05_EVALUARE_FORMATIVA.yaml` | Quiz de evaluare formativă (distribuit Bloom) |

### Documentație Pedagogică

| Fișier | Scop |
|--------|------|
| `C08_01_PLAN_CURS.md` | Obiective de învățare și timing sesiune |
| `C08_02_CONCEPT_MAP.md` | Relații vizuale între concepte |
| `C08_03_INTREBARI_DISCUTIE.md` | Întrebări pentru discuții în grup |
| `C08_04_GHID_STUDIU.md` | Ghid de studiu individual |
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/.../docs/C08_05_EVALUARE_FORMATIVA.yaml
```
